          ...
          <div className="flex flex-col gap-8 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <p className="mt-6 max-w-xl text-base leading-7 text-[#9CA3AF] sm:text-lg">
                Your AWS Student Builder Group profile,
      ...
      <section className="border-t border-white/10 bg-[#0D1421]">
        <div className="mx-auto max-w-360 px-5 py-16 sm:px-8 lg:px-10 lg:py-20">
          <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
            ...
            <Link
              href="/events"
              className="inline-flex w-fit items-center gap-2 border border-[#A855F7] px-5 py-3 text-sm font-medium text-white transition-colors hover:bg-[#A855F7]"
            >
              Explore events
